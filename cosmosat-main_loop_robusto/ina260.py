...
## ina1 (PAYLOAD) setup
ina1_adress = 0x40
ina1 = adafruit_ina260.INA260(i2c, address=ina1_adress)

## ina2 (CONDENSADOR) setup
ina2_address = 0x41
#ina2 = adafruit_ina260.INA260(i2c, address=ina2_address)
...
def log_ina(t0: float):
    ...
    if t > time_counter_ina:
        ...
        ## ina260_1 data
        current, voltage, power = get_current_voltage_power_1()


        info_arr = [INA1_LK, current, voltage, power, round(t, 2)]
